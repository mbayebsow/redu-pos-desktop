...
export default function NumericPad() {
  ...
  return (
    <div className="m-2 rounded-md text-blue-gray-700 h-fit w-auto text-center bg-zinc-700">
      <div className="w-full flex gap-3 text-white">
        <button onClick={() => addDeposit(cartTotal / 3)} className="w-full p-1 bg-primary-700 rounded-md">
          {Number((cartTotal / 3).toPrecision(4))}
        </button>
        <button onClick={() => addDeposit(cartTotal / 2)} className="w-full p-1 bg-primary-700 rounded-md">
          {Number((cartTotal / 2).toPrecision(4))}
        </button>
        <button onClick={() => addDeposit(cartTotal)} className="w-full p-1 bg-primary-200 text-primary-900 rounded-md">
