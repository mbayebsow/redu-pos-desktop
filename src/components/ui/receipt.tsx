...
// function ReceiptV1({ receiptRef = null, totalPrice, deposit, receiptNo, client, products }: ReceiptProps) {
//   return (
//     <div ref={receiptRef} className="text-[black] relative flex flex-col aspect-[1/1.41] w-auto h-full mx-auto bg-[white] rounded-md overflow-scroll">
//       <div className="text-center h-20 flex justify-center items-center font-extrabold text-3xl  border-b border-dashed border-black w-full">REDU POS SYSTEM</div>
...
//                 <tr className="">
//                   <th className="py-1 px-2 border border-t-0 border-l-0 border-black w-2/16 text-center">Qté</th>
...
//                       {product.optionName && <div className="text-xs opacity-70 line-clamp-1 px-2">{product.optionName}</div>}
//                     </td>
//                     <td className="py-1 px-2 text-right border-b border-r">{product.price}</td>
//                     <td className="py-1 px-2 text-right border-b">{product.price * product.quantity}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
    ...
    <div ref={receiptRef} className="text-black relative flex flex-col min-w-[27vw] h-full py-2 px-4 mx-auto bg-white overflow-scroll text-xs">
      <div className="h-fit text-center  justify-center items-start gap-2 w-full">
        ...
        <div className="text-xs">
          <div>+221 78 010 89 62</div>
          <div>mbayebabssow@gmail.com</div>
        </div>
      </div>
