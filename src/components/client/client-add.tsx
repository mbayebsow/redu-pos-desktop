  ...
  return (
    <div className="p-2 w-full">
      ...
      <div className="flex flex-col gap-2 w-full">
        <TextField type="text" label="Prenom" name="firstName" value={clientState.firstName} onChange={handleChange} />
        <TextField type="text" label="Nom" name="lastName" value={clientState.lastName} onChange={handleChange} />
        <TextField type="number" label="Telephone" name="phone" value={clientState.phone} onChange={handleChange} />
        <TextField type="text" label="Adresse" name="address" value={clientState.address} onChange={handleChange} />
        <TextField type="mail" label="Email" name="mail" value={clientState.mail} onChange={handleChange} />
      </div>
    </div>
  );
};
