      ...
      <div className="h-full flex flex-col justify-center items-center gap-5 p-2">
        {NAVIGATIONS.map((nav, i) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `${
                isActive ? "bg-primary-900 text-primary-50 fill-primary-50 rounded-xl" : "fill-primary-900 text-primary-900"
              } aspect-square p-2  w-full flex flex-col gap-2 justify-center items-center`
            }
          >
            {nav.icon}
